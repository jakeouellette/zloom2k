...
αßΓπΣσµτΦΘΩδ∞φε∩≡±≥≤⌠⌡÷≈°∙⋅√ⁿ²■ 
    */
    ...
    fun getKeyStroke(ge: GlobalEditor, actionName: String): KeyStroke {
        return KeyStroke.getKeyStroke(GlobalEditor.getString("K_$actionName"))
    }
    ...
    fun setKeyStroke(ge: GlobalEditor, actionName: String, keyStroke: KeyStroke?) {
        ...
        GlobalEditor.setString("K_$actionName", keyStrokeName)
    }
    ...
    fun charInsert(worldEditor: WorldEditor, editor: JTextComponent, relativeTo: Component?, owner: Any?) {
        ...
        createColourSelector(worldEditor, GlobalEditor.f3char, relativeTo, owner, listener, ColourSelector.CHAR)
    }
